...
<section class="download-hero mt-24 step" data-animate-enter="main-nav--solid">
  <div class="container wrapper wrapper-padding">
    <div class="download-hero--inner flex two-thirds">
      <div class="inner-two-thirds">
        <h1 class="font-extrabold text-5xl md:text-8xl md:pr-10 uppercase font-primary"><?php the_title(); ?></h1>
    ...
    <?php if($hero_text) { ?>
    <div class="download-hero--text description">
      <?php echo $hero_text; ?>
    </div>
    <?php } ?>
...
<section class="download-flexible step
 <?php if($flexible_grey) { ?>
 background-grey
 <?php } ?>" data-animate-enter="main-nav--solid">
  <div class="container wrapper wrapper-padding">
