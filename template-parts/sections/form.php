<?php
/**
 * ACF: Flexible Content > Layouts > Form
 *
 * @package WordPress
 * @subpackage Strategy Institute
 */
$inquiry = get_sub_field('inquiry_form');
$greyInquiry =  get_sub_field('grey_background');
$anchor = get_sub_field('custom_anchor');
// Create id attribute allowing for custom "anchor" value.
$id = 'form-' . get_row_index();
...
<?php if($greyInquiry): ?>
<section class="inquiry-form relative background-grey step" data-animate-enter="main-nav--solid" id="<?= $id; ?>">
<?php else: ?>
<section class="inquiry-form relative step" data-animate-enter="main-nav--solid" id="<?= $id; ?>">
<?php endif; ?>
    <style>
        #<?= $anchor_id; ?> { top: -128px; }
    </style>
    ...
    <div class="md:container wrapper wrapper-padding">
        <div class="inquiry-form--inner">
            <?php if($inquiry['inquiry_form_title']): ?>
              <h2 class="font-extrabold text-4xl md:text-5xl uppercase"><?php echo $inquiry['inquiry_form_title']; ?></h2>
            ...
            <div class="two-thirds">
                <div class="inner-two-thirds">
                    ...
                    <p class="large-font mb-10"> <?php echo $inquiry['intro_paragraph']; ?></p>
                    <?php endif; ?>
                ...
                <div class="mt-0 text-xl">
                    ...
                    <p class="contact-name text-lg uppercase bold mb-3"> <?php echo $inquiry['contact_name']; ?></p>
                    <?php endif; ?>
                    <?php if($inquiry['contact_title']): ?>
                    <p class="uppercase contact-title mb-10"> <?php echo $inquiry['contact_title']; ?></p>
                    <?php endif; ?>
                    <?php if($inquiry['contact_paragraph']): ?>
                    <p class="large-font mb-10"> <?php echo $inquiry['contact_paragraph']; ?></p>
                    <?php endif; ?>
