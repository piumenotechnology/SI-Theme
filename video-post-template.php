...
<section class="post background-grey no-space step py-12 px-10 mt-24 md:mt-32" data-animate-enter="main-nav--solid">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div class="col-span-2 space-y-6">
            ...
            <div class="flex justify-between items-center text-md mt-6">
                ...
                <div class="inline-flex items-center">
                    <button class="flex ui-link border border-solid border-black text-sm" onclick="copyVideoLink()">
        ...
        <div class="col-span-1 border-l px-6 border-gray">
            <div class="w-full h-200 bg-white rounded-lg" style="height: 300px;"></div>

            <h3 class="text-sm text-left font-semibold text-gray-700 py-4">Speaker</h3>
